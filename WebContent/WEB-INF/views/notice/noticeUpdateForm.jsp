			...
			<div class="writeArea">
				<form action="<%= request.getContextPath() %>/update.no" method="post">
					<div>
						...
						<input type="text" id="title_text" name="title" value="<%= n.getN_title() %>">
						<input type="hidden" name="no" value="<%= n.getN_no() %>">
					</div>
					<div>
						<h4 class="label">내용</h4>
						<textarea id="content_text" name="content" ><%= n.getN_content() %></textarea>
					</div>
					<div align="center">
