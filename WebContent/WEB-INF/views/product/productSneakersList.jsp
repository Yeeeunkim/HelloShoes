   ...
   <br>
	  ...
	  <li class="search-li">
	  	<div id="search-li-div"> 	
	 	  ...
	 	  <li class="search-li">		
			  <form  method='GET' action="<%= request.getContextPath() %>/Sne.sn"> 
			    <div id="search-form">	   
			      <select name='col'>
		...
		<div class="thumbnailArea">
		 <div id="ProductTrap"></div>
		  <h4 style="font-size: 28px; color: white; margin-top: -48px; margin-left: 50px; font-family: Typo_SsangmunDong;">스니커즈</h4>
	...
	/* sort 방식 */
		$(function(){
			$('#popular').click(function(){
				...
				location.href="<%= request.getContextPath() %>/listSneSort.to?no=" +  no;	
			});
		});	
		$(function(){
