...
<%
	ArrayList<Product> pList = (ArrayList<Product>)request.getAttribute("pSortList");
	ArrayList<ProductImage> fList = (ArrayList<ProductImage>)request.getAttribute("fSortList");
   ...
   <br>
	  ...
	  <li class="search-li">
	  	<div id="search-li-div"> 	
	 	  ...
	 	  <li class="search-li">		
			  <form  method='GET' action="<%= request.getContextPath() %>/search.bo"> 
			    <div id="search-form">	   
			      <select name='col'>
		...
		<div class="thumbnailArea">
		 <div id="ProductTrap"></div>
		  <h4 style="font-size: 25px; color: white; margin-top: -48px; margin-left: 80px; font-family: Typo_SsangmunDong;">전체</h4>
