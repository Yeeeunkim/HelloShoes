...
table{ font-style: normal; font-weight: bold; font-size: 24px; }
	...
	* {padding:0;margin:0;line-height:1;} /* 기본 브라우저 리셋 스타일 */
	...
	.product_view .img li { float: left; padding: 10px 10px 0 0;  list-style: none; }
	...
	.detailimg1{  
        ...
        #insertBtn{background: black; color:white; font-size:25px; font-weight:bold; padding:5px;}
        #insertBtn:hover,  #cancelBtn:hover{background:#4572C4; opacity:0.5; cursor:pointer;}
...
<body>
	...
	<section>
	<h1 style="margin-left: 280px;font-size:30px;">상품 등록 페이지</h1>
	<form action="<%= request.getContextPath() %>/insert.to" method="post" encType="multipart/form-data">
		<hr style="height: 5px; width: 1300px;  background-color: black; margin-left: 280px; margin-top: 10px;" >	       
	       ...
	       <h4>상품 명</h4>
			  <h2 name="pName" ><textarea name="pName" rows="1" cols="15" style="resize:none; font-size: 20px; "></textarea></h2>
			    <table id="table">
					<col style="width:300px;"> 
					<tbody>
					<tr>
						<th>판매가격</th>
						<td  class="price"><textarea name="price" rows="1" cols="15" style="resize:none; font-size: 20px; "></textarea></td>
					</tr>
					<tr>
						<th>발정보</th>
						<td colspan="2" ><textarea name="pInfo" rows="1" cols="15" style="resize:none; font-size: 20px; "></textarea></td>
					</tr>
					<tr>  
						<td>상품 카테고리</td>
						<td colspan="2" ><textarea name="pcNo" rows="1" cols="15" style="resize:none; font-size: 20px; "></textarea></td>
					</tr>
					<tr>
						<td>배송유형</td>
						<td>무료배송 | KH택배</td>
			...
			<div class="img">
			     <tr>
					 <th colspan= "3">
						<div id="titleImgArea">
							<img id="titleImg" width="550" height="400">
						</div>
					</th>
				</tr>
			</div>	
			...
			<div id="fileArea">
				<input type="file" id="thumbnailImg1" multiple="multiple" name="thumbnailImg1" onchange="LoadImg(this,1)">				
					...
					<div class="btnArea" align="center">
						<input type="submit" id="insertBtn" value="작성완료"  style="  border: 2px solid gray;">
