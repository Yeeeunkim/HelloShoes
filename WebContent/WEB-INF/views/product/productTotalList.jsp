   ...
   <br>
	  ...
	  <li class="search-li">
	  	<div id="search-li-div"> 	
	 	  ...
	 	  <li class="search-li">		
			  <form  method='GET' action="<%= request.getContextPath() %>/pro.to"> 
			    <div id="search-form">	   
			      <select name='col'>
		...
		<div class="thumbnailArea">
		 <div id="ProductTrap"></div>
			<h4 style="font-size: 28px; color: white; margin-top: -43px; margin-left: 55px; font-family: Typo_SsangmunDong;">전체</h4>
	  ...
	  <% if(  loginUser != null && loginUser.getM_Id().equals("admin") ) { %> 
		   <div class="buttonArea" style="visibility:visible;">			 
				<input type="button" style="width: 100px; height: 40px; background: white; color: black; margin-top: 50px; margin-left: 1450px;  font-size: 17px; font-weight: bold; border: 2px solid gray;"
				onclick="location.href='writeForm.to'" id="insertBtn" value="작성하기">
			</div>
		 <% } %>
		...
		************************/
		...
		$(function(){
			$('#popular').click(function(){
				...
				location.href="<%= request.getContextPath() %>/listSort.to?no=" +  no;	
			});
		});	
		$(function(){
