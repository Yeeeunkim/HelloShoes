...
/*자동 슬라이드 끝*/	
	...
	/* 전체 카테고리 명*/
	#ProductTrap{ width:170px; height: -20; border-left: 40px solid transparent; border-right: 40px solid transparent; border-top: 50px solid black;}
   ...
   <br>
	  ...
	  <li class="search-li">
	  	<div id="search-li-div"> 	
	 	  ...
	 	  <li class="search-li">		
			  <form  method='GET' action="<%= request.getContextPath() %>/Sli.sl"> 
			    <div id="search-form">	   
			      <select name='col'>
		...
		<div class="thumbnailArea">
		 <div id="ProductTrap"></div>
		  <h4 style="font-size: 28px; color: white; margin-top: -48px; margin-left: 50px; font-family: Typo_SsangmunDong;">슬리퍼/샌들</h4>
		...
		************************/
		...
		$(function(){
			$('#popular').click(function(){
				...
				location.href="<%= request.getContextPath() %>/listSliSort.to?no=" +  no;	
			});
		});	
		$(function(){
