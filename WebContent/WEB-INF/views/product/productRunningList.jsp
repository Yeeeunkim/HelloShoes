   ...
   <br>
	  ...
	  <li class="search-li">
	  	<div id="search-li-div"> 	
	 	  ...
	 	  <li class="search-li">		
			  <form  method='GET' action="<%= request.getContextPath() %>/Run.ru"> 
			    <div id="search-form">	   
			      <select name='col'>
		...
		<div class="thumbnailArea">
		 <div id="ProductTrap"></div>
		  <h4 style="font-size: 28px; color: white; margin-top: -48px; margin-left: 55px; font-family: Typo_SsangmunDong;">운동화</h4>
		...
		************************/
		...
		$(function(){
			$('#popular').click(function(){
				...
				location.href="<%= request.getContextPath() %>/listRSort.to?no=" +  no;	
			});
		});	
		$(function(){
