...
<%
	Foot f = (Foot)request.getAttribute("footInfo");
	String[] checked = new String[4];
	switch(f.getF_Form()){
	case "기본": checked[0] = "checked";break;
	case "평발": checked[1] = "checked";break;
	case "오목발": checked[2] = "checked";break;
	case "칼발": checked[3] = "checked";break;
}
%>
<!DOCTYPE html>
<html>  
...
<body>
   <%@ include file="../common/menubar.jsp" %>
		...
		<div id="Mypage-link">
			...
			<div id="footInfo">
				<h2 style="margin:0 autuo;">발 정보 수정</h2>
			</div>
			<div>
  			...
  			<form action="<%= request.getContextPath() %>/footUpdate.no" method="post">
  			 
					<tr>
						<td><strong style="padding:0 50px;">발 길이</strong> &nbsp; &nbsp; &nbsp; &nbsp;
						<input type="text"  name="length" required  id="input_text" value="<%= f.getF_Length() %>" ></td>
						<td></td>
					</tr>
					<tr>
						<td><strong style="padding:0 50px;">발 너비</strong> &nbsp; &nbsp; &nbsp; &nbsp;
						<input type="text" name="dimensions" required id="input_text" value="<%= f.getF_Width() %>" ></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td> 
							<div class="footDiv"><img src="images/foot_4.png" class="foot-imgae">기본
                     		  <input type="checkbox" name="type" value="1" <%= checked[0]%>></div>
                    		 <div class="footDiv"><img src="images/foot_2.png" class="foot-imgae">평발
                     		  <input type="checkbox" name="type" value="2" <%= checked[1]%>></div>
                    		 <div class="footDiv"><img src="images/foot_1.png" class="foot-imgae">오목발
                      		 <input type="checkbox" name="type" value="3" <%= checked[2]%>></div>
                     		 <div class="footDiv"><img src="images/foot_4.png" class="foot-imgae">칼발
                      		 <input type="checkbox" name="type" value="4" <%= checked[3]%>> </div>
							</td> 
					</tr>
