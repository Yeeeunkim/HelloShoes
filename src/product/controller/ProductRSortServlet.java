...
/**
 * Servlet implementation class ProductRSortServlet
 */
@WebServlet("/listRSort.to")
public class ProductRSortServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductRSortServlet() {
        super();
		...
		if(no ==1) {
			...
			if (pList != null) {
				 ...
				 System.out.println(fList);
					  ...
					  page = "WEB-INF/views/product/productRunningList.jsp";		 
			}
		}else if(no == 2) {
