...
/**
 * Servlet implementation class ProductWSortServlet
 */
@WebServlet("/listWSort.to")
public class ProductWSortServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductWSortServlet() {
        super();
		...
		if(no ==1) {
			...
			if (pList != null) {
				 ...
				 System.out.println(fList);
					  ...
					  page = "WEB-INF/views/product/productWomanList.jsp";		 
			}
		}else if(no == 2) {
