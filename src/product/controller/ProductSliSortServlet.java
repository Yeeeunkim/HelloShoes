...
/**
 * Servlet implementation class ProductSliSortServlet
 */
@WebServlet("/listSliSort.to")
public class ProductSliSortServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductSliSortServlet() {
        super();
		...
		if(no ==1) {
			...
			if (pList != null) {
				 ...
				 System.out.println(fList);
					  ...
					  page = "WEB-INF/views/product/productSlipperList.jsp";		 
			}
		}else if(no == 2) {
